...
- [-] M5.1 — Multi-human occupancy + bot backfill + join/leave — see [m5-1-multihuman-occupancy.md](m5-1-multihuman-occupancy.md)
- [ ] M5.2 — Spectator overflow queue + auto-join — see [m5-2-spectator-queue.md](m5-2-spectator-queue.md)
