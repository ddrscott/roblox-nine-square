...
- [-] FIX: wall decor is on the OUTSIDE face of the walls (faces the park) → invisible from inside — flip every wall's decor + SurfaceGuis to the INTERIOR (court-facing) side; re-author + verify visually from inside — see [wall-decoration-gym-playful-fades.md](wall-decoration-gym-playful-fades.md)
