...
- [-] Lobby spawn (gallery) + tap-to-join button + opening barrier + lock the building shell — see [lobby-spawn-join-button-barrier.md](lobby-spawn-join-button-barrier.md)
